...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
    ...
    # k3g specific
	export FOX_RECOVERY_INSTALL_PARTITION="/dev/block/mmcblk0p10"
	export FOX_RECOVERY_SYSTEM_PARTITION="/dev/block/mmcblk0p18"
	export FOX_RECOVERY_BOOT_PARTITION="/dev/block/mmcblk0p9"
